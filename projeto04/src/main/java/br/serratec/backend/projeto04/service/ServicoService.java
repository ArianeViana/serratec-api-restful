...
public class ServicoService {
	...
	//relatório usando a query
	public List<Relatorio> relatorioServicos(){
		return servicoRepository.buscarUltimosServicos();
	}
	
	
	
	//relatorio usando JPA	
	
//	public RelatorioDTO ModelToDTO (Servico servico) {
//		
//		RelatorioDTO relatorioDTO = new RelatorioDTO();
//		
//		relatorioDTO.setNomeCliente(servico.getCarro().getCliente().getNomeCliente());
//		relatorioDTO.setModeloCarro(servico.getCarro().getModeloCarro());
//		relatorioDTO.setServicoPrestado(servico.getServicoPrestado());
//		relatorioDTO.setValorServico(servico.getValorServico());		
//		
//		
//		return relatorioDTO;
//	}
	
//	public List<RelatorioDTO> relatorioServicos(){		
//		List<Servico> listaServico = servicoRepository.findTop5ByOrderByDataServicoDesc();
//		List<RelatorioDTO> listaRelatorio = new ArrayList<>();
//		
//		for (Servico servico : listaServico) {
//			RelatorioDTO relatorioDTO = new RelatorioDTO();
//			relatorioDTO = ModelToDTO(servico);		
